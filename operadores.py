...
def JanOperadores():
    ...
    AdminOpLabel.place(x=10, y=300)
    Radiobutton(ClienteFrame,text="Sim",font=("Century Gothic",12),bg="white",value="1",variable=i).place(x=90, y=300)
    Radiobutton(ClienteFrame,text="Não",font=("Century Gothic",12),bg="white",value="2",variable=i).place(x=150, y=300)
    ...
    limparButton = ttk.Button(ClienteFrame,image=imag,command=limpar)
    limparButton.place(x=20,y=410)

    photo01 = PhotoImage(file="img/iconsalvar.png")
    salvarButton = ttk.Button(ClienteFrame, image=photo01,command=salvar)
    salvarButton.place(x=140,y=410)

    photo02 = PhotoImage(file="img/iconExcluir.png")
    deleteButton = ttk.Button(ClienteFrame, image=photo02, command=excluir)
    ...
    getButton = ttk.Button(ClienteFrame, image=photo04, command=alterar)
